...
function tampilbuku()
{
    ...
    if(!empty($result)){
        foreach ($result as $buku) {
            ...
            echo "<td>"."<a href = 'formbuku.php?id_buku=".$buku['id_buku']."'>Edit Buku  </a>";
...
function tampilmember()
{
    ...
    if(!empty($result)){
        foreach ($result as $member) {
            ...
            echo "<td>"."<a href = 'formmember.php?id_member=".$member['id_member']."'>Edit Member </a>";
...
function tampilpeminjaman()
{
    ...
    if(!empty($result)){
        foreach ($result as $peminjaman) {
            ...
            echo "<td>"."<a href = 'formpeminjaman.php?id_peminjaman=".$peminjaman['id_peminjaman']."'>Edit Data Peminjaman       </a>";
            echo "<a href='Peminjaman.php?id_peminjaman=" . $peminjaman['id_peminjaman'] . "' onclick=\"return confirm('lanjut delete ?')\">Hapus Data peminjaman </a> </td>";
            echo "</tr>";
        }
    }
}
